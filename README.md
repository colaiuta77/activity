...
BookOasis에 저장된 독서 진행 기록을 이용해 사용자별 최근 도서 열람·오디오북 청취 활동과 진행률을 보여주는 독립 카테고리 플러그인입니다.

![전용 사용자 활동 탭](docs/activity-tab.png?v=1.3.0)
...
- 일반 서재, 성인 서재와 오디오북 활동을 화면 상단에서 전환합니다.
...
- 일반·성인·오디오북 사용자명은 로그인 사용자 기준 DB인 일반 DB에서 사용자 ID로 매핑합니다.
